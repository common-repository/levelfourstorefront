...
<?php if(isset($title) && count($title) > 0){?><div class="sort_products_header"><?php echo $title; ?></div><?php }?>
    ...
    <div class="sort_products_content" id="sort_pricpoints">
