...
if(userloggedin()){
	...
	$sql = sprintf("UPDATE clients SET ShipName = '%s', ShipLastName = '%s', ShipAddress = '%s', ShipCity = '%s', ShipState = '%s', ShipZip = '%s', ShipCountry = '%s', ShipPhone = '%s' WHERE clients.Email = '%s' AND clients.Password = '%s'", mysql_real_escape_string($_POST['FirstName']), mysql_real_escape_string($_POST['LastName']), mysql_real_escape_string($_POST['Address']), mysql_real_escape_string($_POST['City']), mysql_real_escape_string($_POST['State']), mysql_real_escape_string($_POST['ZipCode']), mysql_real_escape_string($_POST['Country']), mysql_real_escape_string($_POST['Phone']), mysql_real_escape_string($_SESSION['l4username']), mysql_real_escape_string($_SESSION['l4password']));
