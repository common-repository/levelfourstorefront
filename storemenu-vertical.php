...
<?php 
function create_l4_vert_menu($bgcolor1, $bgrollovercolor1, $bgcolor2, $bgrollovercolor2, $bgcolor3, $bgrollovercolor3, $fontcolor1, $fontrollovercolor1, $fontcolor2, $fontrollovercolor2, $fontcolor3, $fontrollovercolor3){
...
#L4navigationVert-holder > li:hover{
 background: <?php echo $bgrollovercolor1; ?>;
}

#L4navigationVert-holder > li > a {
 float: left;
 height: 100%;
...
#L4navigationVert-holder > li > a:hover {
 color: <?php echo $fontrollovercolor1; ?>;
 text-decoration: none;
}

#L4navigationVert-holder > li.L4sub {
 position: relative;
}

#L4navigationVert-holder > li.L4sub ul {
 width: 10em;
 margin: 0;
 list-style: none;
...
#L4navigationVert-holder > li.L4sub ul li {
 padding:0;
 width: 100%;
 margin: 0;
 border:0;
...
#L4navigationVert-holder > li.L4sub ul li:hover {
 background: <?php echo $bgrollovercolor2; ?>;
}

#L4navigationVert-holder > li.L4sub ul li a {
 height: 100%;
 display: block;
 padding: 0.4em;
...
#L4navigationVert-holder > li.L4sub ul li a:hover {
 text-decoration: none;
 color: <?php echo $fontrollovercolor2; ?>;
}

#L4navigationVert-holder > li.L4sub:hover ul {
 right: -10em;
}
...
#L4navigationVert-holder > li ul li.L4subsub {
 position: relative;
}

#L4navigationVert-holder > li ul li.L4subsub ul {
 width: 10em;
 margin: 7px 0 0 0;
 list-style: none;
...
#L4navigationVert-holder > li ul li.L4subsub ul li {
 width: 100%;
 margin: 0;
 border:0;
 padding:0;
...
#L4navigationVert-holder > li ul li.L4subsub ul li:hover {
 background: <?php echo $bgrollovercolor3; ?>;
}

#L4navigationVert-holder > li ul li.L4subsub ul li a {
 height: 100%;
 display: block;
 padding: 0.4em;
...
#L4navigationVert-holder > li ul li.L4subsub ul li a:hover {
 color: <?php echo $fontrollovercolor3; ?>;
 text-decoration: none;
}

#L4navigationVert-holder > li ul li.L4subsub:hover ul {
 left: 9em;
 margin-left:10px;
}
...
$xml_output .= "<ul id=\"L4navigationVert-holder\">"; 
